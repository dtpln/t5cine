// _globallogic_ui.gsc -- Added to manually include hooks in sass' original mod. -4g
// Functions edited: menuClass
...
menuClass( response )
{
	...
	if ( self.sessionstate == "playing" )
	{
		...
		if ( level.inGracePeriod && !self.hasDoneCombat || level.PLAYER_CLASS_CHANGE ) // used weapons check?
		{
