...
dropWeaponForDeath( attacker )	// Handles bots holding guns when dead, removes grace period for picking up weapons
{
	if ( GetDvarInt( #"scr_disable_weapondrop" ) == 1 )
		return;
...
watchPickup() 	// Makes picked up then dropped weapons call the modifed deletePickupAfterAWhile() function
{
	self endon("death");
