...
load_defaults()
{
    ...
    level.BOT_MOVE                  = true;    // [true/false] - Changes all testclients dvars (except _watchKillcam) to make them static
    ...
    level.VISUAL_HUD                = true;    // [true/false] - When false, hides the weaponbar/scorebar/minimap; Uses the scr_gameEnded dvar.
